...
//        override val messageView: MessageView = itemView.findViewById(R.id.itemChatMessage)
//        override val avatar: ImageView = messageView.avatar
//        override val profile: TextView = messageView.profile
//        override val content: TextView = messageView.message
//        override val reactions: FlexBoxLayout = messageView.flexBoxLayout
...
//    }
//
//    override fun onBindViewHolder(holder: ViewHolder, position: Int) = when (items[position]) {
//        is ChatItem.Date -> {
//            paginationAdapterHelper.onBind(position, itemCount)
//            holder as DateViewHolder
//            val item = items[position] as ChatItem.Date
